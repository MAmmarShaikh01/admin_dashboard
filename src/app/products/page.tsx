...
const AdminProductsPage: React.FC = () => {
  ...
  // Delete a product and update the list immediately.
  const handleDelete = async (id: string) => {
    if (confirm("Are you sure you want to delete this product?")) {
      try {
        await client.delete(id);
        // Immediately update the local state so the deleted item is removed from the UI.
  ...
  // • In formState, store only the asset reference (_ref).
  // • Save the returned URL in imagePreview for display.
