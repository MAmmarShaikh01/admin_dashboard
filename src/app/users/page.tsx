...
// Define the User interface matching your Sanity schema.
...
// Type for form input (all fields optional to allow partial updates).
...
const AdminUsersPage: React.FC = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      `);
      // Map the fetched data into our User interface.
  ...
  // Delete a user and immediately update the local state.
  ...
  const handleUpdate = async (e: FormEvent) => {
    ...
    if (editingUser && editingUser._id) {
      try {
        // Explicitly cast the result as a User.
  ...
  const handleAddNew = async (e: FormEvent) => {
    ...
    try {
      ...
      const newUser = (await client.create<User>({
        _type: "user",
        ...formState,
        role: formState.role || "user", // default role is "user"
      })) as User;
  ...
  // For address fields, the input name should be like "address.street", "address.city", etc.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          {editingUser ? (
            <h1 className="text-4xl font-extrabold text-blue-800 mb-4">Edit User</h1>
          ) : (
            <h1 className="text-4xl font-extrabold text-blue-800 mb-4">Users Dashboard</h1>
          )}
        ...
        {showAddForm && !editingUser && (
          ...
          >
            <h2 className="text-2xl font-bold text-blue-600 mb-6">Add New User</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 text-sm text-gray-700">Is Verified</label>
                </div>
                <div>
